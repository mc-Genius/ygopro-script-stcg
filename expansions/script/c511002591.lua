...
function c511002591.initial_effect(c)
	...
	e3:SetCondition(c511002591.atcon)
	...
	e4:SetCondition(c511002591.atkcon)
	e4:SetTarget(c511002591.atktg)
	e4:SetOperation(c511002591.atkop)
	c:RegisterEffect(e4)
end
function c511002591.atfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xc6)
end
function c511002591.atcon(e)
	return Duel.IsExistingMatchingCard(c511002591.atfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,e:GetHandler())
end
function c511002591.atkcon(e,tp,eg,ep,ev,re,r,rp)
