...
function c7005.initial_effect(c)
	...
	e1:SetCost(c7005.cost)
	e1:SetTarget(c7005.target)
	e1:SetOperation(c7005.operation)
	c:RegisterEffect(e1)
end
function c7005.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c7005.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
...
function c7005.operation(e,tp,eg,ep,ev,re,r,rp)
	local sg=Duel.GetMatchingGroup(aux.TRUE,tp,LOCATION_MZONE,LOCATION_MZONE,aux.ExceptThisCard(e))
