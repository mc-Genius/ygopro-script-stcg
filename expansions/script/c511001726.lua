...
function c511001726.initial_effect(c)
	...
	e5:SetOperation(c511001726.atkop)
	c:RegisterEffect(e5)
	...
	e3:SetCondition(c511001726.dircon)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	e4:SetCode(EFFECT_CANNOT_ATTACK)
	e4:SetCondition(c511001726.atkcon)
	c:RegisterEffect(e4)
end
...
function c511001726.dircon(e)
	return e:GetHandler():GetAttackAnnouncedCount()>0
end
function c511001726.atkcon(e)
