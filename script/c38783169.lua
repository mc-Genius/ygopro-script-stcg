...
function c38783169.tnop(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetCondition(c38783169.regcon)
	e2:SetOperation(c38783169.regop)
	...
	e3:SetCondition(c38783169.spcon)
	e3:SetTarget(c38783169.splimit)
	e3:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e3,tp)
end
function c38783169.cfilter(c)
	return c:GetSummonLocation()==LOCATION_EXTRA
end
function c38783169.regcon(e,tp,eg,ep,ev,re,r,rp)
	return rp==tp and eg:IsExists(c38783169.cfilter,1,nil)
end
function c38783169.regop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RegisterFlagEffect(tp,38783169,RESET_PHASE+PHASE_END,0,1)
end
function c38783169.spcon(e)
	local tp=e:GetHandlerPlayer()
	return Duel.GetFlagEffect(tp,38783169)>0
end
function c38783169.splimit(e,c)
